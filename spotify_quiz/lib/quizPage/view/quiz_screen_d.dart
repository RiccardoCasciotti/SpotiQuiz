...
class _QuizDState extends State<QuizD> {
  ...
  @override
  void initState() {
    preview_url = UrlSource(widget.questions![widget.questionIndex]['preview_url']);
            ...
            children: [
              ...
              if (widget.questions![widget.questionIndex]['image'] != null)
                Container(
                  ...
                  height: 200,
                  child: Image.network(
                      (widget.questions![widget.questionIndex]['image'] as model.Image).url,
                      height:
                          (widget.questions![widget.questionIndex]['image'] as model.Image)
                              .heigth
                              .toDouble(),
                      width: (widget.questions![widget.questionIndex]['image'] as model.Image)
                          .width
                          .toDouble()),
                ),
