...
void main() {
  ...
  testWidgets('RankingPage Layout: GoBackLocalRanking',
    ...
    //test
    expect(find.byKey(const Key("GoBackButtonLocalRanking")), findsOneWidget);
  });

  testWidgets('RankingPage Layout: LocalRankingText',
      (WidgetTester tester) async {
    //setup
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    //test
    expect(find.byKey(const Key("LocalRankingText")), findsOneWidget);
  });

  testWidgets('RankingPage Layout: TableLocalRanking',
      (WidgetTester tester) async {
    //setup
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    //test
    expect(find.byKey(const Key("TableLocalRanking")), findsOneWidget);
  });

  testWidgets('RankingPage Layout: UsernameTextLocalRanking',
      (WidgetTester tester) async {
    //setup
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    //test
    expect(find.byKey(const Key("UsernameLocalRanking")), findsOneWidget);
  });

  testWidgets('RankingPage Layout: LevelTextLocalRanking',
      (WidgetTester tester) async {
    //setup
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    //test
    expect(find.byKey(const Key("LevelLocalRanking")), findsOneWidget);
  });

  testWidgets('RankingPage Layout: BestScoreTextLocalRanking',
      (WidgetTester tester) async {
    //setup
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    //test
    expect(find.byKey(const Key("BestScoreLocalRanking")), findsOneWidget);
  });
